...
} LPC_UARTD_API_TypeDef;             // end of structure
...
/* AHB peripherals                                                            */
#define LPC_ROM_DRV_BASE	(LPC_ROM_BASE + 0x1FF8)
#define LPC_UART_DRV_BASE	(LPC_ROM_DRV_BASE + 0x24)
...
#define LPC_UART_DRV		  ((LPC_UARTD_API_TypeDef *) LPC_UART_DRV_BASE )
